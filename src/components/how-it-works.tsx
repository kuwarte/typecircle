...
export function HowItWorks() {
  ...
  "
                        >
                            {/* Image */}
                            <div className="relative min-h-[360px]     rounded-2xl
 md:min-h-0 bg-[var(--color-paper)] overflow-hidden">
      ...
      "
                            ...
                            {/* Text */}
                            <div className="flex flex-col justify-center px-8 py-12 md:px-10 lg:px-12">
                                <h3
                                    className="
        mb-5
        font-heading
