        ...
        <section className="max-w-3xl mx-auto px-6 py-16">
            ...
            <div>
                ...
                <Section title="8. Cookies and Local Storage">
                    ...
                    <p>
                        While you're taking the Enneagram assessment, your in-progress answers
                        are temporarily saved in your browser's session storage so a refresh
                        or accidental navigation doesn't lose your progress. This data:
                    </p>
                    <ul>
                        <li>Stays on your device — it is never sent to our servers until you submit</li>
                        <li>Is automatically cleared once you finish the quiz</li>
                        <li>Is cleared when you close the browser tab (session storage, not persistent storage)</li>
                    </ul>
                    <p>
                        You can clear cookies or storage at any time via your browser settings,
                        which will sign you out of the Platform and discard any in-progress quiz.
                    </p>
                </Section>
